...
df = pd.read_excel('E:\\MyLesson\\Bachelor\\7th Term\\Introduction To Machine Learning\\Project\\Source\\Demo-new\\classic-V1.xlsx')
...
# new_dataset.to_excel('predictions_classic.xlsx', index=False)